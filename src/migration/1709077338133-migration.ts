...
export class Migration1709077338133 implements MigrationInterface {
    name = 'Migration1709077338133'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "repo_commits" ("id" SERIAL NOT NULL, "commitDate" date NOT NULL, "repoId" integer NOT NULL, "numberOfCommits" integer NOT NULL, CONSTRAINT "UQ_4eb87147c4c1c39f7317572a386" UNIQUE ("repoId", "commitDate"), CONSTRAINT "PK_07de39fd0fb0953bb5dfee09f30" PRIMARY KEY ("id", "commitDate", "repoId"))`)
