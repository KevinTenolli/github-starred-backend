...
export class Migration1709224485983 implements MigrationInterface {
    name = 'Migration1709224485983'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "repo_commits" ("commitDate" character varying NOT NULL, "repoId" integer NOT NULL, "numberOfCommits" integer NOT NULL, CONSTRAINT "UQ_4eb87147c4c1c39f7317572a386" UNIQUE ("repoId", "commitDate"), CONSTRAINT "PK_4eb87147c4c1c39f7317572a386" PRIMARY KEY ("commitDate", "repoId"))`)
